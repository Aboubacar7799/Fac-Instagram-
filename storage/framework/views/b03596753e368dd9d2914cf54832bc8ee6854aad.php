...
<?php $__env->startSection('content'); ?>
    ...
    <p>
        ...
        Ou tu suis ce lien pour l'activer votre compte sur ESSOR: <br>
        <a href="<?php echo e(route('app_activation_code_lien',['token' =>$activation_token])); ?>" target="_blank">Confirme votre compte</a>
    </p>

    <p class="text-capitalize text-muted fw-bold text-center">ESSOR une plate Réseau Social développé par Fodé Aboubacar Camara.</p>
