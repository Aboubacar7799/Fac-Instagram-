var Jobick = function(){
   ...
   var handleDzFullScreen = function() {
    ...
    var handleshowPass = function(){
     ...
     var handleshowPasss = function(){
       jQuery('.show-passs').on('click',function(){
           jQuery(this).toggleClass('active');
           if(jQuery('#password-confirm').attr('type') == 'password'){
               jQuery('#password-confirm').attr('type','text');
           }else if(jQuery('#password-confirm').attr('type') == 'text'){
               jQuery('#password-confirm').attr('type','password');
           }
       });
    }
